...
public class Booking1 extends javax.swing.JFrame {
     ...
     public ArrayList<java2project.BusinessObjects.Location> locationsList;
     ...
     public void createToLocationsModel()
     {
         ...
         for(java2project.BusinessObjects.Location loc2:array2)
      {
         ...
         java2project.BusinessObjects.Location toItem=(java2project.BusinessObjects.Location)cmbFrom.getSelectedItem();
         cmbTo.removeItem(toItem);
     ...
     public void createDatesModel()
     {
         ...
         ArrayList<java2project.BusinessObjects.Flight> array3=DatabaseOperations1.GetAllFlightsForLocation(String.valueOf(cmbFrom.getSelectedItem()),String.valueOf(cmbTo.getSelectedItem()));
         for(java2project.BusinessObjects.Flight f1:array3)
         {
             model4.addElement(f1.getDateTime());
         }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
     ...
     DatabaseOperations1.GetAllFlightsForLocation2(String.valueOf(cmbFrom.getSelectedItem()),String.valueOf(cmbTo.getSelectedItem()), flightDate);
