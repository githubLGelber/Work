...
public class Tickets extends javax.swing.JFrame {
    java2project.BusinessObjects.Flight flight1;
    ...
    public void createQuantityModel(java2project.BusinessObjects.Flight flight1)
    {
       ...
       {
           for(int i=0;i<seatsUnoccupied;i++)
           {
               model0.addElement(i);
           }
       }
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
       ...
       if(chk1.isSelected())
       {
           book.setPrice((Integer)cmbTicket.getSelectedItem()*flight1.getPrice()+20);
       }
       else
       {
           book.setPrice((Integer)cmbTicket.getSelectedItem()*flight1.getPrice());
       }
